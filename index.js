...
app.get('/', (req, res) => res.send('Bot is now Online, hehe!'))
...
client.on("ready", async () => {
  console.log(`Yo guys!! OP Bot has been deployed!! 🚀 Coded by Deep#0816`);
  client.user
...
//Do not share bot without credits please, it took a lot of time. And please join our Discord Server, please!
//Discord Link- https://discord.links/elites
//My Bot Link (You can add it to your server)- https://bit.ly/nxtlevelbot